...
class PlayerBasicStrategy(Player):
    ...
    def __init__(self, money):
        ...
        Player.type = "basic strategy"

    @staticmethod
    def play(player_hand, dealer_hand, doubling_down=True):
        """
        ...
        :param player_hand: player hand capped to 10.
        :param dealer_hand: dealer hand capped to 10.
        :param doubling_down: allow doubling after splitting.
